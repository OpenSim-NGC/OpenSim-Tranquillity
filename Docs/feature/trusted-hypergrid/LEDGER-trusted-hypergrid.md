...
| 3 | Trust registry wiring + operator surface (`hgtrust`), no enforcement | **Built, tests green (53/53 incl. MySQL) — uncommitted; D-5 open** | — |
| 3b | Policy engine and region access (enforcement) | Not started | — |
